...
<div class="search-container">
  <div class="search-title">ZQ-Proxy</div>
  <form id="urlForm" onsubmit="redirectToProxy(event)">
    <input type="text" id="targetUrl" placeholder="输入目标网址...">
...
<body>
  <div class="pwd-container">
    <div class="pwd-title">请输入访问密码</div>
    <div class="pwd-tip">本代理受密码保护，请输入访问密码后继续。<br>如需获取密码请联系管理员。</div>
    <input id="password" class="pwd-input" type="password" placeholder="Password" onkeydown="onKeyDown(event)">
    <button class="pwd-btn" onclick="setPassword()">提交</button>
  </div>
</body>
</html>
`;
...
const customFaviconBase64 =
  '';
...
if (request.url.endsWith("favicon.ico")) {
  // 返回自定义 SVG 图标
  return new Response(
    Buffer.from(customFaviconBase64, 'base64'),
    {
      headers: {
